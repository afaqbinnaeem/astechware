...
module ApplicationHelper
  ...
  def blog_articles_list
    [
      ...
      { slug: "reduced-customer-support-tickets-90-percent-ai-agents", path: -> { blog_show_path("reduced-customer-support-tickets-90-percent-ai-agents") }, title: "How We Reduced Customer Support Tickets by 90% with AI Agents", category: "Case Studies", category_slug: "case-studies", excerpt_short: "AI customer support automation that actually cuts tickets: triage, deflection, and human handoff that scales.", excerpt_long: "We deployed AI agents for customer support that handle FAQs, triage, and escalation—and cut inbound tickets by 90% for one client. This case study covers the architecture: knowledge base, confidence thresholds, when to deflect vs escalate, and how we measured impact. Real numbers and what it takes to replicate AI customer support automation that doesn't frustrate users.", read_time: "9 min", date: "Feb 2025", image: "ahmad/3agent.jpeg", author_name: "A'sTechware", author_title: "AI & Platform Engineering" },
